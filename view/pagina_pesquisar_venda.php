            ...
            <div class="card-cadastro-cliente">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <form action="../controller/pagina_pesquisar_venda" method="post">
...
if (isset($_GET["id"]))    
{
    ...
    $venda = $rep->buscarPorId($id);   
    
    if (isset($venda))
    {
        echo $venda->getId() ." - ". $venda->getIdEmpresa() ." - ". $venda->getIdCliente() ." - ". $venda->getData() ." - ". $venda->getvalor() ." - ". $venda->getDolar() ."<br>";
    }
    else{
